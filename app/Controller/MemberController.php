    ...
    public function index(Request $request, Response $response) {
        ...
        $settleQuery = DB::table('settlement_logs')
            ...
            ->select([
                ...
                DB::raw("
                    CASE 
                        WHEN items_json IS NOT NULL AND titles_json IS NOT NULL THEN '아이템, 타이틀 포함'
                        WHEN items_json IS NOT NULL THEN '아이템 포함' 
                        WHEN titles_json IS NOT NULL THEN '타이틀 포함'
                        ELSE '-' 
                    END as quantity_or_desc
                "),
