...
class CharacterController
{
    ...
    public function equipTitle(Request $request, Response $response, $args)
    {
        $charId = $args['id'];
        $groupSlug = $args['group_slug'] ?? '';
        $menuSlug = $args['menu_slug'];
    ...
    private function processCharacterData($request, $group) {
        ...
        return !empty($finalProfile) ? json_encode($finalProfile, JSON_UNESCAPED_UNICODE) : "{}";
    }
