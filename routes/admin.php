...
$app->group('/admin', function (RouteCollectorProxy $group) use (
    ...
    $group->group('/titles', function (RouteCollectorProxy $group) use ($adminShopController) {

        $group->get('', [$adminShopController, 'titleList']);

        $group->post('/store', [$adminShopController, 'titleStore']);

        $group->post('/delete', [$adminShopController, 'titleDelete']);
    ...
    $group->group('/plugins', function (RouteCollectorProxy $group) use ($adminPluginController) {
        ...
        $group->get('/{plugin_name}', [$adminPluginController, 'setting']);

        $group->post('/toggle', [$adminPluginController, 'toggle']);

        $group->post('/{plugin_name}', [$adminPluginController, 'settingSave']);
