...
$app->post('/au/{group_slug}/{menu_slug}/{id:[0-9]+}/title/equip', [$characterController, 'equipTitle']);
...
$app->post('/{menu_slug}/{id:[0-9]+}/title/equip', [$characterController, 'equipTitle']);
