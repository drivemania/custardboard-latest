...
<div class="max-w-5xl mx-auto px-4 py-8 relative">
    ...
    @endif
    <div class="space-y-4">
        @if(!$document->is_secret || $_SESSION['level'] === 10)
                ...
                <div class="flex items-start space-x-3 w-full">
                    ...
                    <div class="w-full">
                        <div class="flex items-center justify-between mb-1">
                            <span class="font-bold text-gray-800 text-sm">{{ $document->nickname }}</span>
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <form action="{{ $currentUrl }}/{{ $document->id }}/delete" method="POST" onsubmit="return confirm('정말 삭제하시겠습니까?');">
