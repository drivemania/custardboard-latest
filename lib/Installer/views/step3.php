...
<form action="<?php echo $basePath; ?>/step3" method="POST" class="space-y-4">
    ...
    <div>
        ...
        <input type="text" name="db_prefix" value="<?php echo $data['db_prefix'] ?? 'cu_'; ?>" placeholder="ex) cu_" class="w-full border border-gray-300 rounded p-2 focus:outline-none focus:border-amber-500" required>
    </div>
