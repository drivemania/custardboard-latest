...
class Widget {
     ...
     */
    public static function menu($basePath = '', $groupSlug = null) {
        if (!$groupSlug) return '';
    ...
    public static function login($basePath = '', $groupSlug = null) {
        ...
        if (isset($_SESSION['user_idx'])) {
            ...
            $html .= '<a href="javascript:void(0);" onclick="window.open(\'' . $basePath . '/memo\', \'memo\', \'width=650,height=700\');" class="custard-memo-link">';
            $html .= '📩 쪽지함 ';
    ...
    public static function latestPosts($basePath = '', $limit = 10, $cutSubject = 20, $menuSlug = [], $groupSlug = []) {
        ...
        if ($items->isEmpty()) {
            ...
            foreach ($items as $item) {
                ...
                $url = "$basePath/au/$groups->slug/$item->menu_slug/$item->doc_num";
