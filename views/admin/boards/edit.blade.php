...
<form action="{{ $base_path }}/admin/boards/update" method="POST">
    ...
    <div class="bg-white p-6 rounded-lg shadow-sm mb-6">
        ...
        <div class="grid grid-cols-4 gap-4 text-center">
            ...
            <div>
                <label class="block text-sm font-bold mb-2 text-neutral-600">글 수정/삭제 권한</label>
                <input type="number" name="edit_level" value="{{ $board->edit_level }}" class="w-20 border rounded px-2 py-1 text-center mx-auto">
            </div>
            <div>
