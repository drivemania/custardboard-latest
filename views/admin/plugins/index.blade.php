                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    <td class="px-6 py-4">
                        <div class="flex items-center">
                            <div class="flex-shrink-0 h-10 w-10 rounded-lg bg-indigo-100 flex items-center justify-center text-indigo-600 font-bold text-lg mr-4">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right">
                        <form action="{{ $base_path }}/admin/plugins/toggle" method="POST">
                            ...
                            <label class="relative inline-flex items-center cursor-pointer group">
                                ...
                                <span class="ml-3 text-sm font-medium text-gray-900 group-hover:text-indigo-600 transition-colors">
