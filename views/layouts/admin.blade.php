        ...
        class="fixed inset-y-0 left-0 z-30 w-64 bg-stone-800 text-white flex flex-col transition-transform duration-300 transform md:translate-x-0 md:static md:inset-0">
            ...
            <nav class="flex-1 overflow-y-auto py-4">
                <ul class="space-y-1">
                    ...
                    <li>
                        <a href="{{ $base_path }}/admin/titles" class="block px-6 py-1 text-gray-300 hover:bg-stone-700 hover:text-white transition">
                            타이틀 관리
                        </a>
                    </li>
                    <li>
                    ...
                    @php \App\Support\Hook::trigger('plugin_menu', $base_path); @endphp
